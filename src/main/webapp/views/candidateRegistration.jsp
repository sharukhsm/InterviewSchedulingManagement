...
<body style="background-color: lightgrey;">
	<nav
		...
		<ul class="navbar-nav ">
			...
			<li class="nav-item"><a class="nav-link"
				href="/hrRegistrationPage">Hr</a></li>

			<li class="nav-item active"><a class="nav-link "
				href="/candidateRegistrationPage">Candidate</a></li>
		</ul>
	...
	<div class="text-center wow fadeInDown" align="center">
		...
		<form action="/candidateRegistration" class="needs-validation" method="POST" novalidate>
			...
			<div class="form-fild" align="center">
				<label for="age">Age:<a  data-toggle="tooltip"
					data-placement="top"
			...
			<div class="form-fild" align="center">
				<label for="gende">Gender:<a 
					data-toggle="tooltip" data-placement="top"
					title="Gender should be M or F"> <input type="text"
					class="form-control" id="gende" placeholder="Enter Gender"
