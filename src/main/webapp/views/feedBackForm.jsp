...
<body style="background-color: lightgrey;">
	...
	<div class="text-center wow fadeInDown" align="center">
		...
		<form action="/feedBackFormSubmit" class="needs-validation" method="POST" novalidate>
			<div class="form-fild" align="center">
				<label for="speed">Speed of Service</label> <input type="text"
					class="form-control" id="speed" 
					name="speedOfService" style="width: 400px;"pattern="[0-9]{1}" required>
				<div class="valid-feedback"></div>
				<div class="invalid-feedback"></div>
			</div>
			<div class="form-fild" align="center">
				<label for="help">helpFullness</label> <input type="text"
					class="form-control" id="help" 
					name="helpFullness" style="width: 400px;"pattern="[0-9]{1}" required>
				<div class="valid-feedback"></div>
				<div class="invalid-feedback"></div>
			</div>
			<div class="form-fild" align="center">
				<label for="exp">experience</label> <input type="text"
					class="form-control" id="exp" 
					name="experience" style="width: 400px;"pattern="[0-9]{1}" required>
				<div class="valid-feedback"></div>
				<div class="invalid-feedback"></div>
			</div>
