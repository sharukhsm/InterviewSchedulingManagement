...
<body style="background-color: lightgrey;">
	...
	<div class="text-center wow fadeInDown" align="center">
		...
		<form action="/candidate_registration" class="needs-validation" method="POST" novalidate>
			...
			<div class="form-fild" align="center">
				<label for="candidate_id">Candidate Id:</label> <a 
					data-toggle="tooltip" data-placement="top"
					title="Employee Id should be of 3 Digits "> <input type="text"
					class="form-control" id="candidate_id" pattern="[0-9]{3}"
					placeholder="Enter Candidate Id" name="candidateId" style="width: 400px;"
					required></a>
				<div class="valid-feedback"></div>
				<div class="invalid-feedback"></div>
			</div>
			...
			<p>
				Already Registered ? <a href="/candidate_login_page">Login Here</a>
			</p>
